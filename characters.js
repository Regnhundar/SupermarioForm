let characters = [
    ...
    },
    {
        ...
        Description : 'Wario, characterized by his portly figure and insatiable greed, embodies the role of a relentless treasure hunter and serves as the yellow-and-purple-clad counterpart to Mario. Frequently embarking on solo escapades, he passionately explores uncharted territories in his quest for wealth and valuable treasures. Notably, Wario has developed an endearing affinity for garlic, which further adds to the complexity of his eccentric personality.',
        Color: `#ffe539`
    },    
    {
        Name : 'Birdo',
        Age : '30',
        Occupation : 'Egg-Throwing Dinosaur',
